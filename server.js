...
app.get("/", (req, res) => res.status(200).send("ABTYP Multi-Flow Server Active"));
  ...
  try {
    ...
    if (action === "INIT" || action === "data_exchange") {
      ...
      let resp = {
        version: "7.1",
        screen: targetScreen,
        data: { country_list: [], state_list: [], parishad_list: [], is_state_enabled: false, is_parishad_enabled: false, can_submit: false }
      };
